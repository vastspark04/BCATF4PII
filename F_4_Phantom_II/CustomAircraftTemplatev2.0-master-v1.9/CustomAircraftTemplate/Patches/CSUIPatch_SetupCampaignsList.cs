...
using CustomAircraftTemplateF4PII.Patches.TranspilerStuff;
using Harmony;
using Harmony.Extensions.CustomAircraftTemplateF4PII;
using RewiredConsts;
using UnityEngine;

namespace CustomAircraftTemplateF4PII.Patches.CampaignStuff
{
    [HarmonyPatch]
